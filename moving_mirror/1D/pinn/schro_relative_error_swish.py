...
from train_1d_moving_swish_delta_dyn import PINN
from train_1d_moving_swish_delta_dyn import construct_interior_sampling_points
from train_1d_moving_swish_delta_dyn import exact_val
from train_1d_moving_swish_delta_dyn import exact_soln
...
udir_name = 'uNN_k_' + str(int(k)) + '_' + str(iterations_lbfgs) + '_' + n_sp_str + n_tm_str + 'pnts_swish_delta_' + str(hid_lay) + '_X_' + str(nodes) + '.pickle'

vdir_name = 'vNN_k_' + str(int(k)) + '_' + str(iterations_lbfgs) + '_' + n_sp_str + n_tm_str+ 'pnts_swish_delta_' + str(hid_lay) + '_X_' + str(nodes) + '.pickle'
...
rel_txt = 'relative_errors_k_' + str(int(k)) + '_' + str(iterations_lbfgs) + '_' + n_sp_str + n_tm_str + 'pnts_swish_delta_' + str(hid_lay) + '_X_' + str(nodes) + '_dyn.txt'
